...
GAME_MESSAGE = "⩹━★⊷━⌞𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗟𝗣𝗢𝗣⌝━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب مارو\n\n⩹━★⊷━⌞𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗟𝗣𝗢𝗣⌝━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('العاب مارو', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗟𝗣𝗢𝗣', url =f"https://t.me/source_alpop")              
                 ],[
...
async def rf3nmla(client, message):
  ...
  await message.reply_text(f"تم رفع العضو : {message.reply_to_message.from_user.mention}\n\n نمله 😂♥️")
...
async def zohary(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/e5d186816dacee4644260.jpg",
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━⌞𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗟𝗣𝗢𝗣⌝━⊶★━⩺\n\nمرحبا بك في قسم العاب مارو 3D\n\n⩹━★⊷━⌞𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗟𝗣𝗢𝗣⌝━⊶★━⩺"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━⌞𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗟𝗣𝗢𝗣⌝━⊶★━⩺\n\n★¦مرحبا بك في قسم العاب مارو\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━⌞𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗟𝗣𝗢𝗣⌝━⊶★━⩺" 
        ...
        InlineKeyboardButton ('⌞𝙎𝙊𝙐𝙍𝘾𝞝〢𝞝𝙇𝙂𝘼𝙕𝘼𝙍⌝⚡️', url =f"https://t.me/source_alpop")              
                 ],[
                InlineKeyboardButton(
                        "‹ رجوع ›", callback_data="close"),
               ],
               ...
               SOURCE_GAME = "⩹━★⊷━⌞𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗟𝗣𝗢𝗣⌝━⊶★━⩺\n\n★¦العاب مارو\n★¦كت\n★¦تويت\n★¦اسال\n★¦اصراحه\n\n⩹━★⊷━⌞𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗟𝗣𝗢𝗣⌝━⊶★━⩺." 

               SORGAM_BUTTON = [
                    [ 
                      InlineKeyboardButton ('⌞𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗟𝗣𝗢𝗣⌝⚡️', url =f"https://t.me/source_alpop")
                      ],[
