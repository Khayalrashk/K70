...
async def init():
    ...
    LOGGER("ميــوزك لاريـن").info("MatrixThon")
    await idle()
    await app.stop()
    await userbot.stop()
    LOGGER("ميــوزك لاريـن").info("جارِ ايقاف بوت الميوزك . . .")
